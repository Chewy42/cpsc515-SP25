...
def exercise2_push_pop():
    ...
    # global transformation on y axis
...
def exercise3_jointAnim():
    ...
    glColor3f(1.0, 1.0, 0.0)
    gluCylinder(quadratic, 3.0, 3.0, arm_cyl_len, 32, 32)
    transforms += 1

    # TODO: Create green sphere (joint) and transform it to be attached to the end of the 
    #       yellow cylinder
    
    glTranslatef(0.0, 0.0, arm_cyl_len)
    glColor3f(0.0, 1.0, 0.0)
    gluSphere(quadratic, 3, 10, 32)
    transforms += 1
    ...
    gluCylinder(quadratic, 2.5, 2.5, arm_cyl_len+5.0, 32, 32)
