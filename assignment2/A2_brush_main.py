...
def main():
    ...
    pygame.display.set_caption('CPSC515: Brushes - Matt Favela')                                      # set title of the program window
    ...
    brush_radius = 30
    canvas.initBrush(brush_radius=brush_radius, brush_color=brush_color,brush_type="speed", density=0.25)      # TODO: switch brush_type here
